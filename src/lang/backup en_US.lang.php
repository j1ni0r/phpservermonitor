...
$sm_lang = array(
	...
	'notifications' => array(
		...
		'off_telegram_message' => " 🚨 %LABEL% OFF <br/>IP: %IP%<br/>Porta: %PORT%<br/>Erro: %ERROR%<br/>Data: %DATE%<br/> www.google.com.br",
		...
		'on_telegram_message' => '✅ \'%LABEL%\' ON novamente, estava OFF por %LAST_OFFLINE_DURATION%:<--! <br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port:--> %PORT%<br/>Data: %DATE%',
	),
	'login' => array(
