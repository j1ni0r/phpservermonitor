...
$sm_lang = array(
	...
	'notifications' => array(
		...
		'on_sms' => 'Servidor \'%LABEL%\' esta ONLINE: ip=%IP%, porta=%PORT%, estava off por %LAST_OFFLINE_DURATION%',
		'on_email_subject' => 'IMPORTANTE: Servidor \'%LABEL%\' esta ONLINE',
		'on_email_body' => "Servidor '%LABEL%' esta ONLINE novamente, estava off por %LAST_OFFLINE_DURATION%:<br/><br/>Servidor: %LABEL%<br/>IP: %IP%<br/>Porta: %PORT%<br/>Data: %DATE%",
		'on_pushover_title' => 'Servidor \'%LABEL%\' esta ONLINE',
		'on_pushover_message' => "Servidor '%LABEL%' esta ONLINE novamente, estava off por %LAST_OFFLINE_DURATION%:<br/><br/>Servidor: %LABEL%<br/>IP: %IP%<br/>Porta: %PORT%<br/>Data: %DATE%",
	),
	'login' => array(
